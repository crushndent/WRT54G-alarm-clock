...
//  Set logic to determine which account is used 
		/* FIM                   LIN account*/
		s.visitorNamespace="fim"
		s.trackingServer="fim.122.2o7.net"
		s.trackingServerSecure="fim.102.122.2o7.net"
		
//		/* foxinteractivemedia   FTS account*/
//		s.visitorNamespace="foxinteractivemedia"
//		s.trackingServer="foxinteractivemedia.122.2o7.net"
//		s.trackingServerSecure="foxinteractivemedia.102.122.2o7.net"
...
/** JOKIM**/
s.linkInternalFilters=lin_linkInternalFilters; 
...
s._channelDomain="Social Networks|facebook.com,myspace.com,twitter.com,youtube.com>Partners|partner1.com,partner2.com"
s._channelParameter="RSS Feeds|rss>Newsletter|nlcid,nlid>Banner Ads|baid"
...
function s_doPlugins(s) {
  ...
  if(!s.campaign){	s.campaign=s.getQueryParam('CMP');//Set campaign here if not set in page already.
  ...
  s.eVar5=s.getValOnce(s.eVar5,'s_evar5',0);}
	...
	if(s._channel)
	{
		...
		s.hier3=s.crossVisitParticipation(s.campaign,'s_campaign_channel','365','15','>','',1);
		s.hier4=s.crossVisitParticipation(s.eVar47,'s_ev47_channel','365','15','>','',1);
		if(s._channel == 'Paid Search' || s._channel == 'Natural Search')
		{
			s.hier1=s._partner + ',' + s._channel + ',' + s._keywords;
		}
	}
/*
	...
	if(s._channel)
	{
		s.prop47 = s.eVar47 = s._channel;
		s.prop48 = s.eVar48 = s._keywords;
		s.prop49 = s.eVar49 = s._partner;
		s.eVar50 = s._referringDomain;
		s.hier3=s.crossVisitParticipation(s.campaign,'s_campaign_channel','365','15','>','',1);
		s.hier4=s.crossVisitParticipation(s.eVar47,'s_ev47_channel','365','15','>','',1);
		if(s._channel == 'Paid Search' || s._channel == 'Natural Search')
...
*/	
	...
	s.prop17=s.getTimeParting('h','-5',year); // Set hour
	s.eVar17=s.prop17=s.prop17.toLowerCase();
	s.prop18=s.getTimeParting('d','-5',year); // Set day
	s.eVar18=s.prop18=s.prop18.toLowerCase();
	s.prop19=s.getTimeParting('w','-5',year); // Set day
	s.eVar19=s.prop19=s.prop19.toLowerCase();
	...
	s.prop20=String( s.prop20 );
	s.eVar20="D=c20";

/* Get Days Since Last Visit */
	s.prop21=s.getDaysSinceLastVisit('s_dayslastvisit');
  ...
  *********************/
  ...
  if(s.prop16&&!s.eVar13) s.eVar13="D=c16";
  ...
  // link tracking configuration variables
	...
	s.setupLinkTrack("prop29,prop30,prop31,prop32","SC_LINK");
...
/* commented out as being suspect for double counting page views 
...
s.trackMilestones = "25,50,75"
s.Media.trackVars="prop29,prop30,prop31,prop32,eVar17,eVar18,eVar19"
...
/**  JOE */
s.pageName = lin_pageName;
s.pageType = lin_pageType;
s.prop1 = lin_prop1;
s.prop2 = lin_prop2;
s.prop3 = lin_prop3;
s.prop4 = lin_prop4;
...
s.prop24 = lin_prop24;
s.prop25 = lin_prop25;
s.campaign = lin_campaign;
s.events = lin_events;
s.products = lin_products;
s.purchaseID = lin_purchaseID;
s.transactionID = lin_transactionID;
s.eVar1 = lin_eVar1;
s.hier2 = lin_hier2;
//code to run
var s_code = s.t();
